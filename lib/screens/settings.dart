...
class SettingsPage extends StatelessWidget {
              ...
              ConstrainedBox(
                ...
                child: Column(
                  children: <Widget>[
                    _heading(
                      context,
                      AppLocalizations.of(context)!.settings_section_appearance,
                    ),
                    Consumer<SettingsModel>(
                      builder: (context, settings, child) => Column(
                        children: <Widget>[
                          _makeCheckbox(
                            context,
                            AppLocalizations.of(context)!.settings_lightMode,
                          ...
                          _makeCheckbox(
                            context,
                            AppLocalizations.of(context)!.settings_showKeywords,
                            settings.showKeywords,
                            (value) =>
                                settings.showKeywords = !settings.showKeywords,
                          ),
                          _makeCheckbox(
                            context,
                            AppLocalizations.of(context)!.settings_showMemo,
                            settings.showMemo,
                            (value) => settings.showMemo = !settings.showMemo,
                          ),
                          _makeCheckbox(
                            context,
                            AppLocalizations.of(context)!.settings_showQuest,
                            settings.showQuest,
                            (value) => settings.showQuest = !settings.showQuest,
                          ),
                          _supportedLanguages.length > 1
                              ? Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 8),
                                    _makeLanguageSelectionSetting(context),
                                  ],
                                )
                              : SizedBox(width: 0),
                        ],
                        ...
                        children: database.quests
                            .map(
                              (quest) => _makeCheckbox(
                                context,
                                (quest.number == null
                                    ? quest.getLocalizedName(settings.language)
                                    : AppLocalizations.of(
                                        context,
                                      )!.settings_quest(
                                        quest.number!,
                      ...
                      builder: (context, settings, child) => Column(
                        children: [
                          ...
                          _makeCheckbox(
                            ...
                            settings.soloMode,
                            (value) => settings.soloMode = !settings.soloMode,
                          ),
                          _makeDescription(
                            context,
                            AppLocalizations.of(
                          ...
                          _makeCheckbox(
                            context,
                            AppLocalizations.of(context)!.settings_smallTableau,
                            settings.smallTableau,
                            (value) =>
                                settings.smallTableau = !settings.smallTableau,
                          ),
                          _makeDescription(
                            context,
                            AppLocalizations.of(
                    ...
                    _heading(
                      context,
                      AppLocalizations.of(context)!.settings_section_comboBias,
                    ),
                    Consumer<SettingsModel>(
                      builder: (context, settings, child) => Column(
                        children: <Widget>[
                          _makeCheckbox(
                            context,
                            AppLocalizations.of(context)!.settings_useComboBias,
                            settings.useComboBias,
                            (value) =>
                                settings.useComboBias = !settings.useComboBias,
                          ),
                          _makeDescription(
                            context,
                            AppLocalizations.of(
                          ...
                          Text(
                            ...
                            style: _createComboBiasLabelTheme(
                              context,
                              settings,
                            ),
                          ),
                    ...
                    Divider(),
                    Text(
                      AppLocalizations.of(context)!.settings_section_misc,
  ...
  Widget _makeDescription(BuildContext context, String text) => Text(
    text,
